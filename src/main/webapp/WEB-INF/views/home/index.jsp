								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="slider_img-box">
											<div>
												<img src="/resources/images/brg.png" alt="" class=""/>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="container">
								<div class="row">
									...
									<div class="col-md-6">
										<div class="slider_img-box">
											<div>
												<img src="/resources/images/slide-img.png" alt="" class=""/>
											</div>
										</div>
									</div>
								</div>
...
<section class="fruit_section">
	<div class="container">
		...
		<div class="row layout_padding2">
			...
			<div class="col-md-4 d-flex justify-content-center align-items-center">
				<div class="fruit_img-box d-flex justify-content-center align-items-center">
					<img src="/resources/images/orange.png" alt="" class="" width="250px"/>
				</div>
			</div>
		</div>
		<div class="row layout_padding2">
			...
			<div class="col-md-4 d-flex justify-content-center align-items-center">
				<div class="fruit_img-box d-flex justify-content-center ">
					<img src="/resources/images/grapes.png" alt="" class="" width="100px"/>
				</div>
			</div>
		</div>
		<div class="row layout_padding2-top layout_padding-bottom">
			...
			<div class="col-md-4 d-flex justify-content-center align-items-center">
				<div class="fruit_img-box d-flex justify-content-center align-items-center">
					<img src="/resources/images/gauva.png" alt="" class="" width="250px"/>
				</div>
			</div>
		</div>
	</div>
