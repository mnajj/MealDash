			...
			<div class="col-md-8">
				<div class="fruit_detail-box">
					...
					<div class="contact_form-container">
						<div>
							<c:url var="updateItemQty" value="/cart/update-new-qty">
								<%--								<c:param name="itemId" value="${item.id}"/>--%>
								<%--								<c:param name="menuId" value="${item.menuId}"/>--%>
							</c:url>
							<form:form action="${updateItemQty}" modelAttribute="item" method="post">
								...
								<div class="mt-5">
									<input type="submit" value="Edit" class="custom_dark-btn"/>
								</div>
							</form:form>
						</div>
					</div>
